...
# python 6DistributionofUserTimeIntervals_fixed.py --csv ./Data/Output/all_users_context_combined_gapLE0_merged.csv --out_dir ./Pictures/GeoLife/
...
# python 6DistributionofUserTimeIntervals_fixed.py --csv ./Data/MoreUser/all_gapLE0_merged.csv --out_dir ./Pictures/MoreUser/
